    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">    
            <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="currentColor" d="M21.6 0H2.4C1.1 0 0 1.1 0 2.4v19.2C0 22.9 1.1 24 2.4 24h9.7v-9.3H8v-3.6h4.1V8.8c0-4.1 2.5-6.3 6.1-6.3c1.7 0 3.2.1 3.6.2v4.2l-2.5.1c-1.9 0-2.3.9-2.3 2.2v2.9h4.6l-.6 3.6h-4V24h8.2c1.3 0 2.4-1.1 2.4-2.4V2.4c0-1.3-1.1-2.4-2.4-2.4z"/></svg>
                  Facebook
                </button>
              </div>  
